...
/////////////////// /No mover !!! ////////////////////////////////////
  ...
  title: string="Agregar Localidad";
  ...
  constructor(
    ...
    public dRef: MatDialogRef<AgregarLocalidadComponent> // Adaptar al objeto correspondiente
  ) { }
  ...
  addRecord(): void {
    ...
    this.localidad.Notas=  this.theForm.controls['notas'].value;
    this.localidad.Keywords=  JSON.stringify(this.keywords);
    this.localidad.uaFecha=  "";
    this.localidad.uaUsuario= "";
    this.localidad.crFecha=  "";
    this.localidad.crUsuario= "";


  this.theService.addRecord(this.localidad)
