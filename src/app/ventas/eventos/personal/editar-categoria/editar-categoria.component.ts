...
export class EditarCategoriaPersonalComponent implements OnInit {
    ...
    constructor(
      ...
      public dRef: MatDialogRef<EditarCategoriaPersonalComponent>, // Adaptar según modelo correspondiente
    ...
    duplicate(valor: string){ // Adaptar a los campos utilizados
      ...
      switch(valor){
        case 'nombre':
          if(this.categoria.Descripcion!=this.theForm.controls['descripcion'].value){
    ...
    editRecord(): void {
      ...
      this.categoria.ID=  this.theForm.controls['itemID'].value;
      this.categoria.Descripcion=  this.theForm.controls['descripcion'].value;
      this.categoria.Keywords=  JSON.stringify(this.keywords);
      this.categoria.Notas=  this.theForm.controls['comentarios'].value;
  
    this.theService.editRecord(this.categoria)
        .subscribe((response: Response) => {
