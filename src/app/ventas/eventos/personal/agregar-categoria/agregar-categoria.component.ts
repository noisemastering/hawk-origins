...
export class AgregarCategoriaPersonalComponent implements OnInit {
...
title: string="Agregar Categoría de Personal";
...
constructor(
  ...
  public dRef: MatDialogRef<AgregarCategoriaPersonalComponent> // Adaptar al objeto correspondiente
) { }
...
duplicate(valor: string){ // Adaptar a los campos utilizados
  ...
  switch(valor){
    case 'nombre':
      this.duplicateService.checkForDuplicates("duplicate", "Descripcion", "Personal_Categorias", this.theForm.controls['descripcion'].value, "Descripcion")
