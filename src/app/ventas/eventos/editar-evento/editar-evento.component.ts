...
export class EditarEventoComponent implements OnInit {
  ...
  constructor(
    ...
    public dRef: MatDialogRef<EditarEventoComponent>, // Adaptar según modelo correspondiente
  ...
  editRecord(): void {
    ...
    this.evento.ID=  this.theForm.controls['itemID'].value;
    this.evento.Descripcion=  this.theForm.controls['descripcion'].value;
    this.evento.Keywords=  JSON.stringify(this.keywords);
    this.evento.Notas=  this.theForm.controls['comentarios'].value;

  this.theService.editRecord(this.evento)
      .subscribe((response: Response) => {
