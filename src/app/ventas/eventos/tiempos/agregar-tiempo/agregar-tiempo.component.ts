...
@Component({
  ...
  styleUrls: ['./agregar-tiempo.component.scss'],
...
constructor(
  ...
  public dRef: MatDialogRef<AgregarTiempoComponent> // Adaptar al objeto correspondiente
) { }
...
addRecord(): void {
  ...
  this.tiempo.Notas=  this.theForm.controls['notas'].value;
  this.tiempo.Keywords=  JSON.stringify(this.keywords);

this.theService.addRecord(this.tiempo)
    .subscribe((response: Response) => {
      if(response.status=="ok"){
        this.notificationService.success('Tiempo creado');
      }
      if(response.status=="error"){
        this.notificationService.error('Error, el Tiempo no pudo ser creado');
      }
  });
