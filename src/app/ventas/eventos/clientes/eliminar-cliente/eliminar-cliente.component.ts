...
export class EliminarClienteComponent implements OnInit {
    ...
    constructor(
      ...
      public dRef: MatDialogRef<EliminarClienteComponent>, //Adaptar al modelo!!!
      ...
      this.theService.deleteRecord(this.theID)
        .subscribe((response: Response) => {
          if(response.status=="ok"){
            this.notificationService.success('Cliente eliminado'); //Adaptar mensajes
          }
          if(response.status=="error"){
            this.notificationService.error('Error, el cliente no pudo ser eliminado'); //Adaptar mensajes
          }
      });
