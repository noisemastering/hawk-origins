...
@Component({
  selector: 'app-editar-elemento-de-menu',
  templateUrl: './editar-elemento-de-menu.component.html',
  styleUrls: ['./editar-elemento-de-menu.component.scss'],
  providers:[AutocompleteService]
})
export class EditarElementoDeMenuComponent implements OnInit {
  ...
  constructor(
    ...
    public dRef: MatDialogRef<EditarElementoDeMenuComponent>, // Adaptar según modelo correspondiente
