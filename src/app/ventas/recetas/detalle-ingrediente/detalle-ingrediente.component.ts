...
@Component({
  selector: 'app-detalle-ingrediente',
  templateUrl: './detalle-ingrediente.component.html',
  styleUrls: ['./detalle-ingrediente.component.scss']
})
export class DetalleIngredienteComponent implements OnInit {
  ...
  constructor(
    ...
    public dRef: MatDialogRef<DetalleIngredienteComponent>, //Adaptar al modelo!!!
