...
constructor(
  ...
  public dRef: MatDialogRef<AgregarPaqueteComponent> // Adaptar al objeto correspondiente
) { }
...
addRecord(): void {
  ...
  this.paquete.Notas=  this.theForm.controls['notas'].value;
  this.paquete.Keywords=  JSON.stringify(this.keywords);
  this.paquete.uaFecha=  "";
  this.paquete.uaUsuario= "";
  this.paquete.crFecha=  "";
  this.paquete.crUsuario= "";

this.theService.addRecord(this.paquete)
    .subscribe((response: Response) => {
      if(response.status=="ok"){
        this.notificationService.success('paquete creado');
      }
      if(response.status=="error"){
        this.notificationService.error('Error, el paquete no pudo ser creado');
      }
  });
