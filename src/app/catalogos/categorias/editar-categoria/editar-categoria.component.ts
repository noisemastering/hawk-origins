...
export class EditarCategoriaComponent implements OnInit {
    ...
    constructor(
      ...
      public dRef: MatDialogRef<EditarCategoriaComponent>, // Adaptar según modelo correspondiente
    ...
    duplicate(valor: string){ // Adaptar a los campos utilizados
      ...
      switch(valor){
        case 'nombre':
          if(this.theForm.controls['descripcion'].value!=this.categoria.Descripcion){
            this.duplicateService.checkForDuplicates("duplicate", "Descripcion", "Articulos_Categorias", 
    ...
    editRecord(): void {
      ...
      this.categoria.ID=  this.theForm.controls['ID'].value;
    ...
    this.theService.editRecord(this.categoria)
        .subscribe((response: Response) => {
          ...
          if(response.status=="error"){
            this.notificationService.error('Error, no fue posible actualizar la categoría');
          }
          //console.log(response);
      });
