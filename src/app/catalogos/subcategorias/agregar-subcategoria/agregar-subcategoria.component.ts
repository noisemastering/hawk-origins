...
@Component({
  ...
  styleUrls: ['./agregar-subcategoria.component.scss'],
...
export class AgregarSubcategoriaComponent implements OnInit {
  ...
  constructor(
    ...
    public dRef: MatDialogRef<AgregarSubcategoriaComponent> // Adaptar al objeto correspondiente
  ) { }
  ...
  duplicate(valor: string){ // Adaptar a los campos utilizados
    ...
    switch(valor){
      case 'nombre':
          this.duplicateService.checkForDuplicates("duplicate", "Descripcion", "Articulos_Subcategorias", 
  ...
  addRecord(): void {
    ...
    this.subcategoria.Notas=  this.theForm.controls['notas'].value;
    ...
    this.subcategoria.uaFecha=  "";
    this.subcategoria.uaUsuario= "";
    this.subcategoria.crFecha=  "";
    this.subcategoria.crUsuario= "";
    this.theService.serviceURL= this.subcategoria.serviceURL;
    this.theService.addRecord(this.subcategoria)
