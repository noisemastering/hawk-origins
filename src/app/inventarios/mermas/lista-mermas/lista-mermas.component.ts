...
@Component({
  selector: 'app-lista-mermas',
  templateUrl: './lista-mermas.component.html',
  styleUrls: ['./lista-mermas.component.scss']
})
export class ListaMermasComponent implements OnInit {
